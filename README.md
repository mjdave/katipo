...
With the release of the iPhone, the web expanded. It rapidly became available to billions of people. It was looking exciting - the web would be available to everyone, except that these new people were not given the tools. They were only allowed to be consumers. The first web was run by nerds for nerds. The second web was run by business for business.
...
There is a lot more to explain, and to work on too, this is a quick overview, and some of what is described here is not yet fully implemented. Katipo is still in the very early stages of development (as of Jan 2026).
...
But I will get more inspired and move faster if people join me. I think maybe there are enough of us not motivated by greed that we can make and use something better. We can do that together, here, now.
